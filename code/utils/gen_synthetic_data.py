...
def homographyGeneration(args, raw_image_path, index):
  ...
  for i in range(args.img_per_real):
    ...
    f_file_list.write((str(index)  +'.jpg '+ str(index)  +'.jpg\n').encode())#('%s %s\n'%(str(index)  +'.jpg', str(index)  +'.jpg') )
...
def main():
  ...
  DATA_NUMBER = 6#100000
  TEST_DATA_NUMBER = 2#5000
  ...
  RAW_DATA_PATH = "/home/yatharth/Desktop/CL/unsupervisedDeepHomographyRAL2018/train/" # Real images used for generating synthetic data
  TEST_RAW_DATA_PATH = "/home/yatharth/Desktop/CL/unsupervisedDeepHomographyRAL2018/test/" # Real images used for generating test synthetic data

  # Synthetic data directories
  DATA_PATH = "/home/yatharth/Desktop/CL/unsupervisedDeepHomographyRAL2018/test/test_synth"
